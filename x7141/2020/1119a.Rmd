...
| PQ1 | 現在感じている大学の総合的な品質       |知覚価値（PQ）|
| PQ2 | 現在感じている学生生活の充実度         |知覚価値（PQ）|
| PQ3 | 現在感じている大学の信頼度             |知覚価値（PQ）|
...
「知覚品質 ← 顧客期待」のパスは 0.493 で有意に推定されているが，「顧客満足 ← 顧客期待」のパスは有意でなく，入学前の期待は大学への品質評価に繋がっているが，大学への満足度には直接繋がっていないことが分かる。「顧客満足 ← 知覚品質」のパスは 1.285 で有意であり，大学への品質評価は満足度に繋がっており，また，入学前の期待は大学への品質評価を通じて満足度に繋がっている。
...
- 質問項目 x1～x12 の数値は，里村（2014）に記載された相関係数行列より復元したシミュレーションデータだが，本データによる分析結果は実際の調査データを用いた分析結果とほぼ等しい
...
### 課題
以下のパス図で共分散構造方程式を実行し，以下の点を考察せよ。

- 「オピニオン・リーダー度」と「eオピニオン・リーダー度」がリアルおよびインターネット上でのクチコミ発信行動にどのように繋がっているか
- リアルおよびインターネット上のクチコミ発信行動が企業への苦情にどのように繋がっているか
