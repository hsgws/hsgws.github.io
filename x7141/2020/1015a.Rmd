...
牛乳データの場合は，回答者10人に対して，1人につき1と2を8回繰り返して，3つの選択肢からの選択データを8回分集めている（1つのidにつき，experimentが8回あり，データの行数は10×8＝80）。このようにして集めたデータにロジット分析を適用することで，回帰係数から消費者の選考に対する各属性・水準の影響を理解することが出来る。
