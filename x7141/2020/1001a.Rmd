...
## 1. 分析例
### データ
**スーパーマーケットでの醤油2商品（A，B）の日次売上データ**（データの一部のみ表示）
...
### Rコード
```{r, results='hide'}
# データ sec3_reg は "Import Dataset" で読込済みとする
# 回帰分析の実行
result <- lm(LogPI_A ~ LogPriceIndex_A + LogPriceIndex_B + Display_A + Display_B, data = sec3_reg)
