...
### 課題
以下の MOVE1（ブランド1の週間販売数量の対数値）を目的変数とした線形回帰モデルで，回帰係数 ($\alpha_0, \beta_1, \dots, \beta_7, \gamma_1, \dots, \gamma_7$) を推定し，結果を解釈せよ。

#### モデル
$$
MOVE_1 = \alpha_0 + \sum_{i=1}^7 \beta_i NSALE_i + \sum_{i=1}^7 \gamma_i LPRICE_i + \varepsilon; \quad
\varepsilon \sim N(0, \sigma^2)
$$

**目的変数**：ブランド1の販売数量の対数値 (MOVE1)  
**説明変数**：ブランド1～7の週間特別陳列実施率 (NSALE1 ~ NSALE7) と週間平均価格の対数値 (LPRICE1 ~ LPRICE7)


<!-- ```{r} -->
<!-- out <- lm(MOVE1 ~ ., data = data_tuna) -->
<!-- summary(out) -->
<!-- ``` -->
